        ...
        while (input.hasNext()) {
            ...
            if (str.equals("---")) {
                ...
                if (command.equals("lecturer-add")) {
                    ...
                    boolean isIDdosenExist = lecturers.stream().anyMatch(lecturer -> lecturer.getIdDosen().equals(IdDosen));
                    ...
                    boolean idCourseIdExist = courses.stream().anyMatch(course -> course.getCourse_id().equals(course_id));
                    ...
                    for (Enrollment enrollment : enrollments) {
                        if (enrollment.getStudent_id().equals(student_id)) {
                            for (Course course : courses) {
                                if (course.getCourse_id().equals(enrollment.getCourse_id())) {
