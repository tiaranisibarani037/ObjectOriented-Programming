...
public class Driver1 {
    ...
    public static void main(String[] _args) {
        ...
        //menandai apakah pengguna telah selesai memasukkan semua data atau tidak. 

        while(input.hasNext()) {
            str = input.nextLine();
            if(str.equals("---")) {
                isFinished = true;
                //mengakibatkan keluar dari loop input dan melanjutkan ke bagian di mana output diproses.
                break;
            }
            else {
                ...
                if (command.equals("course-add")) {
                    ...
                    //menunjukkan bahwa ID kursus yang baru belum ada dalam daftar.
